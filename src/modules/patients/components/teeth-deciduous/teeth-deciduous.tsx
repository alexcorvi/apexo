		...
		return (
			...
			>
				<defs>
					...
					>
						<tspan x="214.21" dy="0em" dominantBaseline="text-before-edge" />
					</text>
					<path
						style={{ cursor: 'pointer' }}
					...
					>
						<tspan
							...
							{...(this.props.teeth[51].notes.length ? { stroke: '#212121' } : {})}
						>
							51
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[52].notes.length ? { stroke: '#212121' } : {})}
						>
							52
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[53].notes.length ? { stroke: '#212121' } : {})}
						>
							53
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[54].notes.length ? { stroke: '#212121' } : {})}
						>
							54
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[55].notes.length ? { stroke: '#212121' } : {})}
						>
							55
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[61].notes.length ? { stroke: '#212121' } : {})}
						>
							61
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[62].notes.length ? { stroke: '#212121' } : {})}
						>
							62
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[63].notes.length ? { stroke: '#212121' } : {})}
						>
							63
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[64].notes.length ? { stroke: '#212121' } : {})}
						>
							64
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[65].notes.length ? { stroke: '#212121' } : {})}
						>
							65
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[81].notes.length ? { stroke: '#212121' } : {})}
						>
							81
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[82].notes.length ? { stroke: '#212121' } : {})}
						>
							82
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[83].notes.length ? { stroke: '#212121' } : {})}
						>
							83
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[84].notes.length ? { stroke: '#212121' } : {})}
						>
							84
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[85].notes.length ? { stroke: '#212121' } : {})}
						>
							85
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[71].notes.length ? { stroke: '#212121' } : {})}
						>
							71
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[73].notes.length ? { stroke: '#212121' } : {})}
						>
							73
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[72].notes.length ? { stroke: '#212121' } : {})}
						>
							72
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[74].notes.length ? { stroke: '#212121' } : {})}
						>
							74
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[75].notes.length ? { stroke: '#212121' } : {})}
						>
							75
						</tspan>
					</text>
				...
				<g className="main">
					<g className="q5">
						<g className="1" onClick={() => this.props.onClick(51)}>
							<g>
								<use xlinkHref="#iso-51" fill={conditionToColor(this.props.teeth[51].condition)} />
								<g>
									<use xlinkHref="#iso-51" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a3GVDWJbDP" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#a3GVDWJbDP" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(52)}>
							<g>
								<use xlinkHref="#iso-52" fill={conditionToColor(this.props.teeth[52].condition)} />
								<g>
									<use xlinkHref="#iso-52" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#c1vrzH7GD" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#c1vrzH7GD" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(53)}>
							<g>
								<use xlinkHref="#iso-53" fill={conditionToColor(this.props.teeth[53].condition)} />
								<g>
									<use xlinkHref="#iso-53" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b2KyfohhGJ" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b2KyfohhGJ" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(54)}>
							<g>
								<use xlinkHref="#iso-54" fill={conditionToColor(this.props.teeth[54].condition)} />
								<g>
									<use xlinkHref="#iso-54" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#cwHRvgNcf" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#cwHRvgNcf" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(55)}>
							<g>
								<use xlinkHref="#iso-55" fill={conditionToColor(this.props.teeth[55].condition)} />
								<g>
									<use xlinkHref="#iso-55" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a882cHHUnK" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#a882cHHUnK" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="ch2ZdTfb">
								<use xlinkHref="#c1Am1SRnuf" opacity="1" fill="#000" />
							</g>
							<g id="aVfNqKx3C">
								<use xlinkHref="#a1wTSzo241" opacity="1" fill="#000" />
							</g>
							<g id="c14SVdlY4">
								<use xlinkHref="#dngiuIzIj" opacity="1" fill="#000" />
							</g>
							<g id="b17vJJzkit">
								<use xlinkHref="#aPscZuMW" opacity="1" fill="#000" />
							</g>
							<g id="bUzQYBN8P">
								<use xlinkHref="#evESRjLHU" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
					<g className="g6">
						<g className="1" onClick={() => this.props.onClick(61)}>
							<g>
								<use xlinkHref="#iso-61" fill={conditionToColor(this.props.teeth[61].condition)} />
								<g>
									<use xlinkHref="#iso-61" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#h1eFc4drSD" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#h1eFc4drSD" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(62)}>
							<g>
								<use xlinkHref="#iso-62" fill={conditionToColor(this.props.teeth[62].condition)} />
								<g>
									<use xlinkHref="#iso-62" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#f8TlGPwTJ" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#f8TlGPwTJ" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(63)}>
							<g>
								<use xlinkHref="#iso-63" fill={conditionToColor(this.props.teeth[63].condition)} />
								<g>
									<use xlinkHref="#iso-63" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a4D4emNiDi" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#a4D4emNiDi" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(64)}>
							<g>
								<use xlinkHref="#iso-64" fill={conditionToColor(this.props.teeth[64].condition)} />
								<g>
									<use xlinkHref="#iso-64" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#g9i5HslOD" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#g9i5HslOD" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(65)}>
							<g>
								<use xlinkHref="#iso-65" fill={conditionToColor(this.props.teeth[65].condition)} />
								<g>
									<use xlinkHref="#iso-65" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#d9AQUN9l" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#d9AQUN9l" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="d2U4NC4l2h">
								<use xlinkHref="#a3vLld1187" opacity="1" fill="#000" />
							</g>
							<g id="chkNbUqVc">
								<use xlinkHref="#d8C077TiQe" opacity="1" fill="#000" />
							</g>
							<g id="e29QMOL8fU">
								<use xlinkHref="#a3dsbSynl2" opacity="1" fill="#000" />
							</g>
							<g id="a2UkPZ9kt7">
								<use xlinkHref="#c3i2cqy5i8" opacity="1" fill="#000" />
							</g>
							<g id="b1ItOC0t1y">
								<use xlinkHref="#c2Gq2EB8T" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
					<g className="q7">
						<g className="1" onClick={() => this.props.onClick(71)}>
							<g>
								<use xlinkHref="#iso-71" fill={conditionToColor(this.props.teeth[71].condition)} />
								<g>
									<use xlinkHref="#iso-71" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#f1SexwZEcq" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#f1SexwZEcq" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(72)}>
							<g>
								<use xlinkHref="#iso-72" fill={conditionToColor(this.props.teeth[72].condition)} />
								<g>
									<use xlinkHref="#iso-72" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b9tcVaTZ" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b9tcVaTZ" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(73)}>
							<g>
								<use xlinkHref="#iso-73" fill={conditionToColor(this.props.teeth[73].condition)} />
								<g>
									<use xlinkHref="#iso-73" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#hdg0tmh2L" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#hdg0tmh2L" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(74)}>
							<g>
								<use xlinkHref="#iso-74" fill={conditionToColor(this.props.teeth[74].condition)} />
								<g>
									<use xlinkHref="#iso-74" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a4VwzCcbws" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#a4VwzCcbws" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(75)}>
							<g>
								<use xlinkHref="#iso-75" fill={conditionToColor(this.props.teeth[75].condition)} />
								<g>
									<use xlinkHref="#iso-75" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#h46WoT2rhW" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#h46WoT2rhW" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="bbGVcBKeK">
								<use xlinkHref="#a253G7JNHZ" opacity="1" fill="#000" />
							</g>
							<g id="a2LizwfKkt">
								<use xlinkHref="#dgSWNXQt1" opacity="1" fill="#000" />
							</g>
							<g id="a1dli2uYZu">
								<use xlinkHref="#b1fKZ8Bv2u" opacity="1" fill="#000" />
							</g>
							<g id="aCcMzwUXK">
								<use xlinkHref="#b83Atca9Z" opacity="1" fill="#000" />
							</g>
							<g id="b1Rz4H5VcT">
								<use xlinkHref="#hfHo0NDB3" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
					<g className="q8">
						<g className="1" onClick={() => this.props.onClick(81)}>
							<g>
								<use xlinkHref="#iso-81" fill={conditionToColor(this.props.teeth[81].condition)} />
								<g>
									<use xlinkHref="#iso-81" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#baO5m8gAJ" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#baO5m8gAJ" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(82)}>
							<g>
								<use xlinkHref="#iso-82" fill={conditionToColor(this.props.teeth[82].condition)} />
								<g>
									<use xlinkHref="#iso-82" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b1OuMQtEP6" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b1OuMQtEP6" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(83)}>
							<g>
								<use xlinkHref="#iso-83" fill={conditionToColor(this.props.teeth[83].condition)} />
								<g>
									<use xlinkHref="#iso-83" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b2roP7vEXi" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b2roP7vEXi" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(84)}>
							<g>
								<use xlinkHref="#iso-84" fill={conditionToColor(this.props.teeth[84].condition)} />
								<g>
									<use xlinkHref="#iso-84" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a5EcJWHaOD" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#a5EcJWHaOD" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(85)}>
							<g>
								<use xlinkHref="#iso-85" fill={conditionToColor(this.props.teeth[85].condition)} />
								<g>
									<use xlinkHref="#iso-85" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#avxQ9BjFX" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#avxQ9BjFX" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="e17J4GcJHT">
								<use xlinkHref="#a1jKNA7rAN" opacity="1" fill="#000" />
							</g>
							<g id="a1vZchl36W">
								<use xlinkHref="#aAHeijBe5" opacity="1" fill="#000" />
							</g>
							<g id="a1LXneLur">
								<use xlinkHref="#ek5cw6Hgp" opacity="1" fill="#000" />
							</g>
							<g id="btsq7lcvc">
								<use xlinkHref="#g2rNJx6rxS" opacity="1" fill="#000" />
							</g>
							<g id="dber0XavM">
								<use xlinkHref="#d14UMdDj6N" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
				</g>
