				...
				<defs>
					...
					>
						<tspan
							...
							{...(this.props.teeth[11].notes.length ? { stroke: '#212121' } : {})}
						>
							11
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[12].notes.length ? { stroke: '#212121' } : {})}
						>
							12
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[13].notes.length ? { stroke: '#212121' } : {})}
						>
							13
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[14].notes.length ? { stroke: '#212121' } : {})}
						>
							14
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[15].notes.length ? { stroke: '#212121' } : {})}
						>
							15
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[16].notes.length ? { stroke: '#212121' } : {})}
						>
							16
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[17].notes.length ? { stroke: '#212121' } : {})}
						>
							17
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[18].notes.length ? { stroke: '#212121' } : {})}
						>
							18
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[21].notes.length ? { stroke: '#212121' } : {})}
						>
							21
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[22].notes.length ? { stroke: '#212121' } : {})}
						>
							22
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[23].notes.length ? { stroke: '#212121' } : {})}
						>
							23
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[24].notes.length ? { stroke: '#212121' } : {})}
						>
							24
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[25].notes.length ? { stroke: '#212121' } : {})}
						>
							25
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[26].notes.length ? { stroke: '#212121' } : {})}
						>
							26
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[27].notes.length ? { stroke: '#212121' } : {})}
						>
							27
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[28].notes.length ? { stroke: '#212121' } : {})}
						>
							28
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[41].notes.length ? { stroke: '#212121' } : {})}
						>
							41
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[42].notes.length ? { stroke: '#212121' } : {})}
						>
							42
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[43].notes.length ? { stroke: '#212121' } : {})}
						>
							43
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[44].notes.length ? { stroke: '#212121' } : {})}
						>
							44
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[45].notes.length ? { stroke: '#212121' } : {})}
						>
							45
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[46].notes.length ? { stroke: '#212121' } : {})}
						>
							46
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[47].notes.length ? { stroke: '#212121' } : {})}
						>
							47
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[48].notes.length ? { stroke: '#212121' } : {})}
						>
							48
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[31].notes.length ? { stroke: '#212121' } : {})}
						>
							31
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[32].notes.length ? { stroke: '#212121' } : {})}
						>
							32
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[34].notes.length ? { stroke: '#212121' } : {})}
						>
							34
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[33].notes.length ? { stroke: '#212121' } : {})}
						>
							33
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[35].notes.length ? { stroke: '#212121' } : {})}
						>
							35
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[36].notes.length ? { stroke: '#212121' } : {})}
						>
							36
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[37].notes.length ? { stroke: '#212121' } : {})}
						>
							37
						</tspan>
					</text>
					...
					>
						<tspan
							...
							dy="0em"
							dominantBaseline="text-before-edge"
							{...(this.props.teeth[38].notes.length ? { stroke: '#212121' } : {})}
						>
							38
						</tspan>
					</text>
				...
				<g className="main">
					<g className="q1">
						<g className="1" onClick={() => this.props.onClick(11)}>
							<g>
								<use xlinkHref="#iso-11" fill={conditionToColor(this.props.teeth[11].condition)} />
								<g>
									<use xlinkHref="#iso-11" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#iso-11a" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#iso-11a" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(12)}>
							<g>
								<use xlinkHref="#iso-12" fill={conditionToColor(this.props.teeth[12].condition)} />
								<g>
									<use xlinkHref="#iso-12" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#iso-12a" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#iso-12a" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(13)}>
							<g>
								<use xlinkHref="#iso-13" fill={conditionToColor(this.props.teeth[13].condition)} />
								<g>
									<use xlinkHref="#iso-13" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#iso-13a" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#iso-13a" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(14)}>
							<g>
								<use xlinkHref="#iso-14" fill={conditionToColor(this.props.teeth[14].condition)} />
								<g>
									<use xlinkHref="#iso-14" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b6fpiYGql" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b6fpiYGql" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#cyecxkyP8" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#cyecxkyP8" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(15)}>
							<g>
								<use xlinkHref="#iso-15" fill={conditionToColor(this.props.teeth[15].condition)} />
								<g>
									<use xlinkHref="#iso-15" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b22znv61x" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b22znv61x" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a3AsQKojJ1" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#a3AsQKojJ1" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="6" onClick={() => this.props.onClick(16)}>
							<g>
								<use xlinkHref="#iso-16" fill={conditionToColor(this.props.teeth[16].condition)} />
								<g>
									<use xlinkHref="#iso-16" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b6rcDQpXhc" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#b6rcDQpXhc" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="7" onClick={() => this.props.onClick(17)}>
							<g>
								<use xlinkHref="#iso-17" fill={conditionToColor(this.props.teeth[17].condition)} />
								<g>
									<use xlinkHref="#iso-17" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#iso-17a" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#iso-17a" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="8" onClick={() => this.props.onClick(18)}>
							<g>
								<use xlinkHref="#iso-18" fill={conditionToColor(this.props.teeth[18].condition)} />
								<g>
									<use xlinkHref="#iso-18" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b2DYah0Bi" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#b2DYah0Bi" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="e1BKNeURVa">
								<use xlinkHref="#dhJLWP0Rx" opacity="1" fill="#000" />
							</g>
							<g id="c11nH75JKG">
								<use xlinkHref="#h484gZh3x" opacity="1" fill="#000" />
							</g>
							<g id="apGn9cSxF">
								<use xlinkHref="#a5HTD7Ziun" opacity="1" fill="#000" />
							</g>
							<g id="bjZ1YSxTN">
								<use xlinkHref="#dPldy7HEx" opacity="1" fill="#000" />
							</g>
							<g id="fg2EsfBeL">
								<use xlinkHref="#aagZSuMJr" opacity="1" fill="#000" />
							</g>
							<g id="a5Xmbxqft">
								<use xlinkHref="#c3f2gAlj3" opacity="1" fill="#000" />
							</g>
							<g id="a3IMKLYnOx">
								<use xlinkHref="#fWwh13pJ" opacity="1" fill="#000" />
							</g>
							<g id="c31CWrtXNW">
								<use xlinkHref="#iALQXea9Y" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
					<g className="q2">
						<g className="1" onClick={() => this.props.onClick(21)}>
							<g>
								<use xlinkHref="#iso-21" fill={conditionToColor(this.props.teeth[21].condition)} />
								<g>
									<use xlinkHref="#iso-21" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#h3ymJ8JsAJ" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#h3ymJ8JsAJ" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(22)}>
							<g>
								<use xlinkHref="#iso-22" fill={conditionToColor(this.props.teeth[22].condition)} />
								<g>
									<use xlinkHref="#iso-22" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#e7zZFZz9XZ" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#e7zZFZz9XZ" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(23)}>
							<g>
								<use xlinkHref="#iso-23" fill={conditionToColor(this.props.teeth[23].condition)} />
								<g>
									<use xlinkHref="#iso-23" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#bX8HWOfji" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#bX8HWOfji" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(24)}>
							<g>
								<use xlinkHref="#iso-24" fill={conditionToColor(this.props.teeth[24].condition)} />
								<g>
									<use xlinkHref="#iso-24" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#d6p4ZsEBwV" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#d6p4ZsEBwV" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b2b6VhQYX9" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b2b6VhQYX9" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(25)}>
							<g>
								<use xlinkHref="#iso-25" fill={conditionToColor(this.props.teeth[25].condition)} />
								<g>
									<use xlinkHref="#iso-25" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a1IjZsIm8S" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#a1IjZsIm8S" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b2JgD7E2Kq" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#b2JgD7E2Kq" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="6" onClick={() => this.props.onClick(26)}>
							<g>
								<use xlinkHref="#iso-26" fill={conditionToColor(this.props.teeth[26].condition)} />
								<g>
									<use xlinkHref="#iso-26" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#aLBv0ngyf" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#aLBv0ngyf" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="7" onClick={() => this.props.onClick(27)}>
							<g>
								<use xlinkHref="#iso-27" fill={conditionToColor(this.props.teeth[27].condition)} />
								<g>
									<use xlinkHref="#iso-27" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#lmVcyt8R" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#lmVcyt8R" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="8" onClick={() => this.props.onClick(28)}>
							<g>
								<use xlinkHref="#iso-28" fill={conditionToColor(this.props.teeth[28].condition)} />
								<g>
									<use xlinkHref="#iso-28" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#bsHecJRYc" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#bsHecJRYc" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="c2vG1vlZh4">
								<use xlinkHref="#b1gODCfJB5" opacity="1" fill="#000" />
							</g>
							<g id="a1nYN9cpt">
								<use xlinkHref="#a2KwBh9N1C" opacity="1" fill="#000" />
							</g>
							<g id="bAKpE8e15">
								<use xlinkHref="#avSr25PQ8" opacity="1" fill="#000" />
							</g>
							<g id="f13C0Z9htE">
								<use xlinkHref="#b1IAgvlN7L" opacity="1" fill="#000" />
							</g>
							<g id="h2OfTRUQ6B">
								<use xlinkHref="#a5jdHsmSg" opacity="1" fill="#000" />
							</g>
							<g id="b4tUNqNk6T">
								<use xlinkHref="#eEJTk9OPg" opacity="1" fill="#000" />
							</g>
							<g id="clBT5njbz">
								<use xlinkHref="#a1kI1wu28" opacity="1" fill="#000" />
							</g>
							<g id="aG1IO93Cx">
								<use xlinkHref="#f10grZcqP0" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
					<g className="q3">
						<g className="1" onClick={() => this.props.onClick(31)}>
							<g>
								<use xlinkHref="#iso-31" fill={conditionToColor(this.props.teeth[31].condition)} />
								<g>
									<use xlinkHref="#iso-31" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#cjuFfUWr" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#cjuFfUWr" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(32)}>
							<g>
								<use xlinkHref="#iso-32" fill={conditionToColor(this.props.teeth[32].condition)} />
								<g>
									<use xlinkHref="#iso-32" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#ahVnr1hTO" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#ahVnr1hTO" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(33)}>
							<g>
								<use xlinkHref="#iso-33" fill={conditionToColor(this.props.teeth[33].condition)} />
								<g>
									<use xlinkHref="#iso-33" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#d2sFISoAcr" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#d2sFISoAcr" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(34)}>
							<g>
								<use xlinkHref="#iso-34" fill={conditionToColor(this.props.teeth[34].condition)} />
								<g>
									<use xlinkHref="#iso-34" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#f1nJy2rCGI" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#f1nJy2rCGI" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#aaB5NMNJEr" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#aaB5NMNJEr" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(35)}>
							<g>
								<use xlinkHref="#iso-35" fill={conditionToColor(this.props.teeth[35].condition)} />
								<g>
									<use xlinkHref="#iso-35" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#bHt0uYEvE" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#bHt0uYEvE" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#awAtPqnox" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#awAtPqnox" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="6" onClick={() => this.props.onClick(36)}>
							<g>
								<use xlinkHref="#iso-36" fill={conditionToColor(this.props.teeth[36].condition)} />
								<g>
									<use xlinkHref="#iso-36" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#m211qMeGpL" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#m211qMeGpL" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="7" onClick={() => this.props.onClick(37)}>
							<g>
								<use xlinkHref="#iso-37" fill={conditionToColor(this.props.teeth[37].condition)} />
								<g>
									<use xlinkHref="#iso-37" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b5JyusjzlT" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#b5JyusjzlT" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="8" onClick={() => this.props.onClick(38)}>
							<g>
								<use xlinkHref="#iso-38" fill={conditionToColor(this.props.teeth[38].condition)} />
								<g>
									<use xlinkHref="#iso-38" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a9wXxhEQy" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#a9wXxhEQy" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="a8me8h3BSZ">
								<use xlinkHref="#b1BVUVOWBq" opacity="1" fill="#000" />
							</g>
							<g id="aXE5ZGRZF">
								<use xlinkHref="#a3t972Cvsg" opacity="1" fill="#000" />
							</g>
							<g id="c3IdvmfULY">
								<use xlinkHref="#i4mHUxK2re" opacity="1" fill="#000" />
							</g>
							<g id="d4igiagCc0">
								<use xlinkHref="#d3EsTPegQ" opacity="1" fill="#000" />
							</g>
							<g id="b4CCaq9LOV">
								<use xlinkHref="#b2ApfidLEf" opacity="1" fill="#000" />
							</g>
							<g id="ako4Nkrak">
								<use xlinkHref="#b2aRoIXnu9" opacity="1" fill="#000" />
							</g>
							<g id="eBV6uRJmu">
								<use xlinkHref="#a1E40eZIMw" opacity="1" fill="#000" />
							</g>
							<g id="aQUtEqY2g">
								<use xlinkHref="#b18Xayl0Ve" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
					<g className="q4">
						<g className="1" onClick={() => this.props.onClick(41)}>
							<g>
								<use xlinkHref="#iso-41" fill={conditionToColor(this.props.teeth[41].condition)} />
								<g>
									<use xlinkHref="#iso-41" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#a2Ot1hj5Ti" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#a2Ot1hj5Ti" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="2" onClick={() => this.props.onClick(42)}>
							<g>
								<use xlinkHref="#iso-42" fill={conditionToColor(this.props.teeth[42].condition)} />
								<g>
									<use xlinkHref="#iso-42" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#c3OkjuGmoe" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#c3OkjuGmoe" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="3" onClick={() => this.props.onClick(43)}>
							<g>
								<use xlinkHref="#iso-43" fill={conditionToColor(this.props.teeth[43].condition)} />
								<g>
									<use xlinkHref="#iso-43" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#c1DvhakQel" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#c1DvhakQel" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="4" onClick={() => this.props.onClick(44)}>
							<g>
								<use xlinkHref="#iso-44" fill={conditionToColor(this.props.teeth[44].condition)} />
								<g>
									<use xlinkHref="#iso-44" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>

							<g>
								<use xlinkHref="#c2SUh81nX8" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#c2SUh81nX8" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#d38q1jr7XL" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#d38q1jr7XL" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="5" onClick={() => this.props.onClick(45)}>
							<g>
								<use xlinkHref="#iso-45" fill={conditionToColor(this.props.teeth[45].condition)} />
								<g>
									<use xlinkHref="#iso-45" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#c9QkCsAMn" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#c9QkCsAMn" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#amh0k6iSv" opacity="1" fillOpacity="0" />
								<g>
									<use xlinkHref="#amh0k6iSv" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
						</g>
						<g className="6" onClick={() => this.props.onClick(46)}>
							<g>
								<use xlinkHref="#iso-46" fill={conditionToColor(this.props.teeth[46].condition)} />
								<g>
									<use xlinkHref="#iso-46" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b3NaX9ixLx" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#b3NaX9ixLx" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="7" onClick={() => this.props.onClick(47)}>
							<g>
								<use xlinkHref="#iso-47" fill={conditionToColor(this.props.teeth[47].condition)} />
								<g>
									<use xlinkHref="#iso-47" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#c18sfWQXw1" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#c18sfWQXw1" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="8" onClick={() => this.props.onClick(48)}>
							<g>
								<use xlinkHref="#iso-48" fill={conditionToColor(this.props.teeth[48].condition)} />
								<g>
									<use xlinkHref="#iso-48" fillOpacity="0" stroke="#000" strokeWidth="2" />
								</g>
							</g>
							<g>
								<use xlinkHref="#b7ARVWKg9" opacity="1" fill="#000" />
								<g>
									<use xlinkHref="#b7ARVWKg9" fillOpacity="0" stroke="#000" strokeWidth="0" />
								</g>
							</g>
						</g>
						<g className="text">
							<g id="esxiVjmkn">
								<use xlinkHref="#b85Z9biXKR" opacity="1" fill="#000" />
							</g>
							<g id="a5VexlPOx">
								<use xlinkHref="#c1DY6ILtkz" opacity="1" fill="#000" />
							</g>
							<g id="aaP8d9N3o">
								<use xlinkHref="#b7Um5lGNA6" opacity="1" fill="#000" />
							</g>
							<g id="adSaYX4L8">
								<use xlinkHref="#bFYSV3ojY" opacity="1" fill="#000" />
							</g>
							<g id="f5VTtmANks">
								<use xlinkHref="#a58joFtV32" opacity="1" fill="#000" />
							</g>
							<g id="akb2LDStY">
								<use xlinkHref="#d1FL8DxoUa" opacity="1" fill="#000" />
							</g>
							<g id="iGZzsgY86">
								<use xlinkHref="#c1WvdIbIzw" opacity="1" fill="#000" />
							</g>
							<g id="b43283rfI4">
								<use xlinkHref="#g1ie3fhzhA" opacity="1" fill="#000" />
							</g>
						</g>
					</g>
				</g>
