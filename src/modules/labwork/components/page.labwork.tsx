									...
									>
										...
										<TagInputComponent
											...
											onChange={(selectedKeys) => {
												this.selectedLabwork!.involvedTeeth =
													selectedKeys.map((x) =>
														num(x)
													);
											}}
										...
										<TextField
											...
											data-testid="lw-case"
											value={
												this.selectedLabwork.caseDetails
											}
											onChange={(ev, val) =>
												(this.selectedLabwork!.caseDetails =
													val!)
										...
										<TagInputComponent
											...
											onChange={(newKeys) => {
												this.selectedLabwork!.operatingStaffIDs =
													newKeys;
											}}
											disabled={!this.canEdit}
											suggestionsHeaderText={
